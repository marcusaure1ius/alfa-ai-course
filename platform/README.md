...
получает прямой origin n8n. Launch проходит через одноразовый ticket и Caddy
gateway; после срока, revoke или общего service off сохранённый адрес и
существующая n8n login session блокируются на каждом запросе. Перенос VPS и
