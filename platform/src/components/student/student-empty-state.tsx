...
const content = {
  ...
  // В обоих состояниях курс неизвестен, поэтому ведём в каталог: ссылка на
  // `/student/program` без параметра открыла бы первый курс из назначенных.
  empty: {
    icon: BookOpenText,
  ...
  missing: {
    ...
    description:
      "Возможно, он ещё не опубликован или доступ к курсу изменился. Откройте список курсов и выберите доступный материал.",
    action: "Открыть мои курсы",
    href: "/student",
  },
} as const;
