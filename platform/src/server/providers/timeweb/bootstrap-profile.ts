...
export const STARTER_KIT_BOOTSTRAP_PROFILE = Object.freeze({
  ...
  version: "starter-kit-v0.1.14",
  // v0.1.12 поведение не менял: перевыпущен из-за неверной описи полей лога в
  // комментарии профиля. v0.1.11 распространил вырезание на заголовки запроса,
  // v0.1.10 сделал то же для query — имена секретов задают n8n и провайдеры,
  // поэтому перечислить их нельзя (T-0118). Предыдущие круги той же темы —
  // v0.1.8 и v0.1.9; v0.1.6 убрал из общего профиля личный файл подтверждения
  // владения, v0.1.7 исправил ложное утверждение в комментарии.
  ...
  installerUrl:
    ...
    "alfa-ai-course/releases/download/v0.1.12/install.sh",
  installerSha256:
    "76ac0c14fd8529fe1ee49a8d0ea361c79c7d34700b234cf4548c6ae6012b230a",
  n8nVersion: "2.29.10",
