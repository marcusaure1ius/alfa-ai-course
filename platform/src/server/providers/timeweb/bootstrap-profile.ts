...
export const STARTER_KIT_BOOTSTRAP_PROFILE = Object.freeze({
  ...
  version: "starter-kit-v0.1.16",
  // v0.1.14 добавил страницу оператора на корень учебного n8n (T-0120) и
  // доработанный по боевым урокам путь обновления кода (T-0135, T-0138).
  // v0.1.13 вырезал из лога Caddy ответные заголовки целиком (T-0127) и
  // первым нёс путь обновления кода развёрнутых хостов (T-0130). v0.1.12
  // перевыпущен из-за неверной описи полей лога, v0.1.11 и v0.1.10 —
  // вырезание заголовков запроса и query (T-0118).
  ...
  installerUrl:
    ...
    "alfa-ai-course/releases/download/v0.1.14/install.sh",
  installerSha256:
