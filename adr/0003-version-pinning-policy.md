...
| Компонент | Pin | Evidence |
|---|---|---|
| n8n | `docker.n8n.io/n8nio/n8n:2.29.10` | [dated research](../docs/research/2026-07-13-platform-versions-and-license.md#результат) |
| PostgreSQL | `postgres:17.10-bookworm` | [dated research](../docs/research/2026-07-13-platform-versions-and-license.md#результат) |
| Caddy | `caddy:2.11.4-alpine` | [dated research](../docs/research/2026-07-13-platform-versions-and-license.md#результат) |
| Docker Engine, Ubuntu 24.04 amd64 | `5:29.6.1-1~ubuntu.24.04~noble` | [dated research](../docs/research/2026-07-13-platform-versions-and-license.md#результат) |
| Docker Compose plugin, Ubuntu 24.04 amd64 | `5.3.1-1~ubuntu.24.04~noble` | [dated research](../docs/research/2026-07-13-platform-versions-and-license.md#результат) |
...
Implementation обязан отклонить отсутствующий, плавающий или неразрешённый target. Реальный pull проверяет availability для `linux/amd64`, а resolved digests добавляются в release evidence. Отсутствие image, health failure или smoke-test failure останавливает update и запускает документированную restore-based процедуру, но не автоматический image-only downgrade.
