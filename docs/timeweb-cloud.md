...
Проверено по официальной документации: 2026-07-14. Названия кнопок в панели могут измениться; опирайтесь на обязательные параметры ниже и актуальную [инструкцию создания сервера](https://timeweb.cloud/docs/cloud-servers/manage-servers/create-server), а не только на screenshots.

## Итог этого guide

Чистый сервер с Ubuntu 24.04 LTS x86_64, закреплённым за аккаунтом публичным IPv4, рабочим SSH и открытыми TCP 22/80/443. После проверки переходите к [домену и DNS](domain-and-dns.md), затем к [Quick Start](quick-start.md).
