...
Проверено: 2026-07-14. Дополнено 2026-07-15. Цель преподавателя — довести участника до самостоятельного владения системой, не становясь хранителем его secrets или постоянным оператором VPS. Отдельный общий стенд преподавателя разворачивается по короткой инструкции [на `neurokurs.ru`](instructor-setup.md), а первый показ проводится по [памятке о четырёх бизнес-шаблонах](instructor-templates.md). Стенд не заменяет самостоятельный participant flow.
