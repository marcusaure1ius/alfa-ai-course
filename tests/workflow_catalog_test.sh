...
ok "all five exact source lesson JSON files import into one clean pinned n8n database"
...
ok "portability-staged import contains five inactive lessons without credential references"
