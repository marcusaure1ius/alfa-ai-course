...
ok "ten demo and supporting dangerous-action contract suites"
...
ok "all ten exact source lesson JSON files import into one clean pinned n8n database"
...
ok "portability-staged import contains ten inactive lessons without credential references"
