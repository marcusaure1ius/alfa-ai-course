...
| `telegram-support-relay` | `tests/telegram_support_relay_test.sh` | безопасный routing private/group Reply, allowlist, Google Sheets mapping и send gate advanced workflow | Node.js | `FAIL` |
