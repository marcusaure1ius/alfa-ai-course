...
| `workflow-import` | `tests/workflow_catalog_test.sh` | beginner UX gate и clean import пяти standalone-уроков в pinned n8n | Docker daemon, exact n8n image | local `SKIP`, CI `FAIL` |
