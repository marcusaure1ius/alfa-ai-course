...
| `workflow-import` | `tests/workflow_catalog_test.sh` | schema/fixtures и clean import 19 workflow в pinned n8n | Docker daemon, exact n8n image | local `SKIP`, CI `FAIL` |
